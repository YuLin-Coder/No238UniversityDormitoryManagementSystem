<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="物品" prop="wupin">
          <el-input v-model="ruleForm.wupin" 
              placeholder="物品" clearable  :readonly="ro.wupin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="物品" prop="wupin">
              <el-input v-model="ruleForm.wupin" 
                placeholder="物品" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
