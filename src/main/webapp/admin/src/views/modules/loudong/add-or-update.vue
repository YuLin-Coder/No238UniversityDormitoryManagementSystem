          ...
          <el-form-item class="input" label="位置" prop="weizhi">
              <el-input v-model="ruleForm.weizhi" 
                placeholder="位置" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="层数" prop="cengshu">
          <el-input v-model="ruleForm.cengshu" 
              placeholder="层数" clearable  :readonly="ro.cengshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="层数" prop="cengshu">
              <el-input v-model="ruleForm.cengshu" 
                placeholder="层数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.weizhi = true;
            continue;
	            	            ...
	            	            if(o=='cengshu'){
            this.ruleForm.cengshu = obj[o];
	    this.ro.cengshu = true;
            continue;
          }
	            	            if(o=='susheshuliang'){
