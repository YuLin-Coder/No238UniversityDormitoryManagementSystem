    ...
    >
      <el-row>
        ...
        <el-form-item class="select" v-if="type!='info'"  label="是否咳嗽" prop="shifoukesou">
          <el-select v-model="ruleForm.shifoukesou" placeholder="请选择是否咳嗽">
            <el-option
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.shifoukesou"
                placeholder="是否咳嗽" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否腹泻" prop="shifoufuxie">
          <el-select v-model="ruleForm.shifoufuxie" placeholder="请选择是否腹泻">
            <el-option
                v-for="(item,index) in shifoufuxieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否腹泻" prop="shifoufuxie">
	      <el-input v-model="ruleForm.shifoufuxie"
                placeholder="是否腹泻" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否乏力" prop="shifoufali">
          <el-select v-model="ruleForm.shifoufali" placeholder="请选择是否乏力">
            <el-option
                v-for="(item,index) in shifoufaliOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否乏力" prop="shifoufali">
	      <el-input v-model="ruleForm.shifoufali"
                placeholder="是否乏力" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否就医" prop="shifoujiuyi">
          <el-select v-model="ruleForm.shifoujiuyi" placeholder="请选择是否就医">
            <el-option
                v-for="(item,index) in shifoujiuyiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否就医" prop="shifoujiuyi">
	      <el-input v-model="ruleForm.shifoujiuyi"
                placeholder="是否就医" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="其他情况" prop="qitaqingkuang">
          <el-input v-model="ruleForm.qitaqingkuang" 
              placeholder="其他情况" clearable  :readonly="ro.qitaqingkuang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="其他情况" prop="qitaqingkuang">
              <el-input v-model="ruleForm.qitaqingkuang" 
                placeholder="其他情况" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  data() {
	...
	shangbaoshijian : false,
            ...
            ruleForm: {
                  ...
                  shifoufuxie: [
                            { required: true, message: '是否腹泻不能为空', trigger: 'blur' },
                                    	                                                              ],
                  shifoufali: [
                            { required: true, message: '是否乏力不能为空', trigger: 'blur' },
                                    	                                                              ],
                  shifoujiuyi: [
                            { required: true, message: '是否就医不能为空', trigger: 'blur' },
                                    	                                                              ],
                  qitaqingkuang: [
                                    	                                                              ],
                  shangbaoshijian: [
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shifoukesou = true;
            continue;
	            	            ...
	            	            if(o=='shifoufuxie'){
            this.ruleForm.shifoufuxie = obj[o];
	    this.ro.shifoufuxie = true;
            continue;
          }
	            	            if(o=='shifoufali'){
            this.ruleForm.shifoufali = obj[o];
	    this.ro.shifoufali = true;
            continue;
          }
	            	            if(o=='shifoujiuyi'){
            this.ruleForm.shifoujiuyi = obj[o];
	    this.ro.shifoujiuyi = true;
            continue;
          }
	            	            if(o=='qitaqingkuang'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                        ...
                                        this.shifoufuxieOptions = "是,否".split(',')
                                        this.shifoufaliOptions = "是,否".split(',')
                                        this.shifoujiuyiOptions = "是,否".split(',')
                                                                },
                                                                                        // 多级联动参数
                                                                                                                info(id) {
      this.$http({
