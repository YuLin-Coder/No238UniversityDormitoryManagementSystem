          ...
          <el-form-item class="input" label="楼栋" prop="loudong">
              <el-input v-model="ruleForm.loudong" 
                placeholder="楼栋" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="借用说明" prop="jieyongshuoming">
          <el-input v-model="ruleForm.jieyongshuoming" 
              placeholder="借用说明" clearable  :readonly="ro.jieyongshuoming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="借用说明" prop="jieyongshuoming">
              <el-input v-model="ruleForm.jieyongshuoming" 
                placeholder="借用说明" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `wupinjieyong/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.wupinjieyongCrossAddOrUpdateFlag = false;
                  this.parent.search();
