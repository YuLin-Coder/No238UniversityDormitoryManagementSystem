          ...
          <el-form-item class="input" label="楼栋" prop="loudong">
              <el-input v-model="ruleForm.loudong" 
                placeholder="楼栋" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="退宿说明" prop="tuisushuoming">
          <el-input v-model="ruleForm.tuisushuoming" 
              placeholder="退宿说明" clearable  :readonly="ro.tuisushuoming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="退宿说明" prop="tuisushuoming">
              <el-input v-model="ruleForm.tuisushuoming" 
                placeholder="退宿说明" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
