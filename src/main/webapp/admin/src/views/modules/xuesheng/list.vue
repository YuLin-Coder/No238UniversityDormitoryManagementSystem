<template>
  <div class="main-content">
		    ...
		    label="宿舍号">
		     <template slot-scope="scope">
                ...
                <el-button v-if="isAuth('xuesheng','缴费') && contents.tableBtnIcon == 0" type="success" size="mini" @click="jiaofeixinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'缴费':'' }}</el-button>
                                                <el-button v-if="isAuth('xuesheng','晚归') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="xueshengwanguiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'晚归':'' }}</el-button>
                <el-button v-if="isAuth('xuesheng','晚归') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="xueshengwanguiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'晚归':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('xuesheng','晚归') && contents.tableBtnIcon == 0" type="success" size="mini" @click="xueshengwanguiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'晚归':'' }}</el-button>
                                                <el-button v-if="isAuth('xuesheng','检查') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="sushejianchaCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'检查':'' }}</el-button>
                <el-button v-if="isAuth('xuesheng','检查') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="sushejianchaCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'检查':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('xuesheng','检查') && contents.tableBtnIcon == 0" type="success" size="mini" @click="sushejianchaCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'检查':'' }}</el-button>
    ...
    <add-or-update v-if="addOrUpdateFlag" :parent="this" ref="addOrUpdate"></add-or-update>
        ...
        <xueshengwangui-cross-add-or-update v-if="xueshengwanguiCrossAddOrUpdateFlag" :parent="this" ref="xueshengwanguiCrossaddOrUpdate"></xueshengwangui-cross-add-or-update>
        <sushejiancha-cross-add-or-update v-if="sushejianchaCrossAddOrUpdateFlag" :parent="this" ref="sushejianchaCrossaddOrUpdate"></sushejiancha-cross-add-or-update>
...
import xueshengwanguiCrossAddOrUpdate from "../xueshengwangui/add-or-update";
import sushejianchaCrossAddOrUpdate from "../sushejiancha/add-or-update";
export default {
  data() {
    return {
                                                                                                                                                                                                searchForm: {
      ...
      addOrUpdateFlag:false,
            ...
            xueshengwanguiCrossAddOrUpdateFlag: false,
            sushejianchaCrossAddOrUpdateFlag: false,
  ...
  components: {
    AddOrUpdate,
        ...
        xueshengwanguiCrossAddOrUpdate,
        sushejianchaCrossAddOrUpdate,
          },
  methods: {
    contentStyleChange() {
    ...
    contentPageStyleChange(){
      ...
      this.$nextTick(() => {
        ...
        xueshengwanguiCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.xueshengwanguiCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','xuesheng');
      this.$nextTick(() => {
        this.$refs.xueshengwanguiCrossaddOrUpdate.init(row.id,type);
      });
    },
        sushejianchaCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.sushejianchaCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','xuesheng');
      this.$nextTick(() => {
        this.$refs.sushejianchaCrossaddOrUpdate.init(row.id,type);
      });
    },
                    init () {
                                                                                                                                                                                                                                                                          },
